...
`langchain-pop` is the extraction-ready runtime integration package for Persona Object Protocol (POP). It exposes a LangChain-native middleware/toolkit layer for agent construction and carries the minimum POP object loading and legacy migration logic required for standalone runtime integration.
